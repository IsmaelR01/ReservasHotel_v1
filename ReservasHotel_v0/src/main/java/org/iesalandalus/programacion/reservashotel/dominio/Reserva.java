...
public class Reserva {
    ...
    public void setNumeroPersonas(int numeroPersonas) {
        ...
        if(numeroPersonas > TipoHabitacion.SUITE.getNumeroMaximoPersonas()) {
            throw new IllegalArgumentException("ERROR: No se puede superar el máximo de personas permitido en la habitación suite.");
        }
        if (numeroPersonas > TipoHabitacion.DOBLE.getNumeroMaximoPersonas()) {
            throw new IllegalArgumentException("ERROR: No se puede superar el máximo de personas permitido en la habitación doble.");
        }
        if(numeroPersonas > TipoHabitacion.TRIPLE.getNumeroMaximoPersonas()) {
            throw new IllegalArgumentException("ERROR: No se puede superar el máximo de personas permitido en la habitación triple.");
        }
        if(numeroPersonas > TipoHabitacion.SIMPLE.getNumeroMaximoPersonas()) {
            throw new IllegalArgumentException("ERROR: No se puede superar el máximo de personas permitido en la habitación simpple.");
        }
